    ...
    <div class="venue-main">
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" class="search-filter-form">
            ...
            <div class="add-container">
                <button type="button" class="apply-button" onclick="location.href='add.php?cat=d'">
                    Add Decoration
                </button>
            </div>
        </form>
            ...
            echo '
                <div class="divi">
                    ...
                    <div class="left">
                        ...
                        <button class=button><a href="modify.php?c=d&id='.$row["did"].'" >modify</a></button>
                        <button class=button><a href="delete.php?cat=d&id='.$row["did"].'" >delete</a></button>
                    </div>
                    </div>
                </div>';
        }
