    ...
    <div class="venue-main">
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" class="search-filter-form">
            ...
            <div class="add-container">
                <button type="button" class="apply-button" onclick="location.href='add.php?cat=m'">
                    Add Music
                </button>
            </div>
        </form>
                ...
                <div class="divi">
                    ...
                    <div class="left">
                        ...
                        <div class="summa-flex">
                            ...
                            <button class=button><a href="modify.php?c=m&id='.$row["mid"].'" >modify</a></button>
                            <button class=button><a href="delete.php?c=m&id='.$row["mid"].'" >delete</a></button>
                        </div>
