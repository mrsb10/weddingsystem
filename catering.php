    ...
    .b3{
        ...
        <body>
            ...
            <div class="topic">
                ...
                <form method="post" action="catering.php?v1=<?php echo $v1; ?>&v2=<?php echo $v2; ?>&v3=<?php echo $v3; ?>&v4=<?php echo $v4; ?>&ve1=<?php echo $ve1 ; ?>&t1=<?php echo $t1 ; ?>&c1=<?php echo $c1 ; ?>&m1=<?php echo $m1 ; ?>&d1=<?php echo $d1 ; ?>&p1=<?php echo $p1 ; ?>" class="search-filter-form">
                ...
                while ($row = pg_fetch_assoc($result)) {
                    ...
                    $sno=sanitizeInput($conn, $row["cid"]);
                    echo '
                    <div class="divi">
                        <div class="photo">
                        ...
                        <div class="left">
                            ...
                            <div class="rating">'.
                                $d.
                            '</div>
                            <button class=b1><a href="confirm.php?number='.$sno.'&category=c&un='.$un.'&v1='.$v1.'&v2='.$v2.'&v3='.$v3.'&v4='.$v4.'&ve1='.$ve1.'&t1='.$t1.'&c1='.$c1.'&m1='.$m1.'&d1='.$d1.'&p1='.$p1.'"  >Add</a></button>
