    ...
    <div class="venue-main">
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" class="search-filter-form">
            ...
            <div class="add-container">
                <button type="button" class="apply-button" onclick="location.href='add.php?cat=c'">
                    Add Catering
                </button>
            </div>
        </form>
                ...
                <div class="divi">
                    ...
                    <div class="left">
                        ...
                        <div class="summa-flex">
                            <button class=button><a href="modify.php?c=c&id='.$row["cid"].'" >modify</a></button>
                            <button class=button><a href="delete.php?c=c&id='.$row["cid"].'" >delete</a></button>
                        </div>
                    </div>
                </div>';
        }
