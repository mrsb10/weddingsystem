...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (isset($_POST["search"])) {
            ...
            $query .= " WHERE name ILIKE '".substr($searchQuery, 0, 2)."%' OR descr ILIKE '".substr($searchQuery, 0, 2)."%'";
        }
...
if (!$result) {
    ...
    <div class="venue-main">
        ...
        <form method="post" action="music.php?v1=<?php echo $v1; ?>&v2=<?php echo $v2; ?>&v3=<?php echo $v3; ?>&v4=<?php echo $v4; ?>&ve1=<?php echo $ve1 ; ?>&t1=<?php echo $t1 ; ?>&c1=<?php echo $c1 ; ?>&m1=<?php echo $m1 ; ?>&d1=<?php echo $d1 ; ?>&p1=<?php echo $p1 ; ?>" class="search-filter-form">
            <label for="search">Search Music or Description:</label>
            <input type="text" id="search" name="search" placeholder="Enter music or description">
            ...
            echo '
                <div class="divi">
                    ...
                    <div class="left">
                        ...
                        <button class=b1><a href="confirm.php?number='.$row["mid"].'&category=m&un='.$un.'&v1='.$v1.'&v2='.$v2.'&v3='.$v3.'&v4='.$v4.'&ve1='.$ve1.'&t1='.$t1.'&c1='.$c1.'&m1='.$m1.'&d1='.$d1.'&p1='.$p1.'"  >Add</a></button>
