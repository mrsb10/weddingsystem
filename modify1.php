...
if ($_SERVER["REQUEST_METHOD"] == "POST" ) {
    ...
    $id=  isset($_GET['id']) ? $_GET['id'] : '';
    header("Location: frontend1.php?id=$id");
                exit();
                /*
    if ($cat=='v'){
        $n=$_POST["nm"];
...
<body>
    ...
    <form action=".php?cat=v&id=<?php echo $id; ?>" method="post">
    ...
    <form action="add.php?cat=t&id=<?php echo $id ?>" method="post">
    ...
    <form action="add.php?cat=c&id=<?php echo $id ?>" method="post">
    ...
    <form action="add.php?cat=m&id=<?php echo $id ?>" method="post">
    ...
    <form action="add.php?cat=d&id=<?php echo $id ?>" method="post">
    ...
    <form action="add.php?cat=p&id=<?php echo $id ?>" method="post">
