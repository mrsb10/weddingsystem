...
<body>
    ...
    <div class="venue-main">
        ...
        <div class="add-container">
                <button type="button" class="apply-button" onclick="location.href='add.php?cat=v'">
                    Add Venue
                </button>
            </div>
        </form>
                ...
                <div class="divi">
                    ...
                    <div class="left">
                        ...
                        <div class="summa-flex">
                            <button class=button><a href="modify.php?c=v&id='.$row["venue_id"].'" >Modify</a></button>
                            <button class=button><a href="delete.php?c=v&id='.$row["venue_id"].'" >delete</a></button>
                        </div>
                    </div>
                </div>';
            }
